...
import (
	...
	"github.com/edgexfoundry/device-gps-go/internal/handler/callback"
...
func metricsHandler(w http.ResponseWriter, _ *http.Request) {
	...
	// (Here, we fetch metrics for a given device service that's been generated by device-gps-go.)
